...
local function loadTabMain()
    ...
    _G.AutoEquipToggle =  FishingSection:Toggle({
    ...
    AddSave("AutoEquipRodToggle", _G.AutoEquipToggle)

    -- [[ AUTO FISHING ENABLE + AUTO HIDE NOTIF ]]
    _G.AutoFishingToggle = FishingSection:Toggle({
    ...
    AddSave("AutoFishingToggle", _G.AutoFishingToggle)
...
local function loadTabEvent()
    ...
    local function collectCrystals()
        ...
        local oldEquip = _G.AutoEquipToggle.Value
        local oldFishing = _G.AutoFishingToggle.Value

        _G.AutoFishingToggle:Set(false)
        _G.AutoEquipToggle:Set(false)
        ...
        if #crystals == 0 then
            ...
            _G.AutoFishingToggle:Set(oldFishing)
            _G.AutoEquipToggle:Set(oldEquip)
            isRunning = false
            return
        end
